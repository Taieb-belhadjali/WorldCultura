...
public class participation {
    ...
    private event eventObj; // Référence à l'événement
    ...
    public event getEventObj() { return eventObj; }
    public void setEventObj(event eventObj) { this.eventObj = eventObj; }
    ...
    public String toString() {
        return "participation{" +
                ...
                ", email='" + email + '\'' +
                ", telephone=" + telephone +
                (eventObj != null ? ", eventName=" + eventObj.getName() : "") +
                '}';
    }
}