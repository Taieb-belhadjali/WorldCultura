...
final class EventController extends AbstractController{
    ...
    public function index(
        ...
        // Utilisation d'un QueryBuilder pour paginer
    ...
    public function show(int $id,EventRepository $eventRepository, ParticipationRepository $participationRepository): Response
    {
