...
final class ReponseController extends AbstractController
{
    ...
    public function Anew(Request $request, EntityManagerInterface $entityManager , ReclamationRepository $reclamtionRepository , int $ReclamationId): Response
    {
    ...
    // route pour creation de reponse par le client
    #[Route('/Cnew/{ReclamationId}', name: 'app_reponse_new_client', methods: ['GET', 'POST'])]
    public function Cnew(Request $request, EntityManagerInterface $entityManager , ReclamationRepository $reclamtionRepository , int $ReclamationId , ValidatorInterface $validator): Response
    {
        $reclamation = $entityManager->getRepository(Reclamation::class)->find($ReclamationId);
        $reponse = new Reponse();
        $form = $this->createForm(ReponseType::class, $reponse);
