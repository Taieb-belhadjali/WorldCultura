...
public class event {
    ...
    public boolean equals(Object o) {
        ...
        event event = (event) o;
        return ID == event.ID && Objects.equals(Name, event.Name) && Objects.equals(date_debut, event.date_debut) && Objects.equals(date_fin, event.date_fin) && Objects.equals(Description, event.Description) && Objects.equals(image, event.image);
    }
