...
public class Reservationservice implements iservice<Reservation> {
    ...
    public void add(Reservation reservation) {
        String sql = "INSERT INTO reservation (rehla_id, userName, email, contact, userId) VALUES (?, ?, ?, ?, ?)";
    ...
    public void update(Reservation reservation) {
        String sql = "UPDATE reservation SET rehla_id = ?, userName = ?, email = ?, contact = ?, userId = ? WHERE id = ?";
    ...
    public Reservation getById(int id) {
        ...
        try (PreparedStatement pst = connection.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                reservation.setUserId((Integer) rs.getObject("userId")); // Handle potential null
                return reservation;
            } else {
